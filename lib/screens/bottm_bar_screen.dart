...
import 'package:grocery_app/screens/categoriesScreen.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
            icon: Icon(
              _selectedIndex == 0 ? IconlyBold.category : IconlyLight.category,
            ),
            label: "Category",
          ),
          BottomNavigationBarItem(
            icon: Consumer<CartProvider>(builder: (
              _,
              myCart,
              ch,
            ) {
              return Badge(
                ...
                child: Icon(
                  _selectedIndex == 0 ? IconlyBold.buy : IconlyLight.buy,
                ),
              );
            }),
            label: "Cart",
